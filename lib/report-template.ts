...
@page{size:A4;margin:0}*{box-sizing:border-box}html{print-color-adjust:exact;-webkit-print-color-adjust:exact}body{margin:0;background:#fff;color:#17213A;font-family:Arial,Helvetica,sans-serif;font-size:10.2px;line-height:1.5}
...
.notched-frame{position:absolute;inset:0;width:100%;height:100%;z-index:0;pointer-events:none;overflow:visible}.notched-frame path{vector-effect:non-scaling-stroke;stroke-width:.65;fill:rgba(255,255,255,.18);stroke:rgba(201,121,98,.48)}.executive-box{margin-top:17mm;padding:9mm 10mm 8mm;position:relative;min-height:61mm}.executive-box>*:not(.notched-frame){position:relative;z-index:1}.executive-frame path{fill:rgba(255,255,255,.20);stroke:rgba(201,121,98,.48)}.box-heading{text-transform:uppercase;letter-spacing:.18em;color:var(--navy);font-size:8.5px;display:flex;align-items:center;gap:7px}.box-spark{width:13px;height:13px;color:var(--terracotta);flex:none}.executive-box p{font-family:Georgia,'Times New Roman',serif;font-size:11.2px;line-height:1.65;margin:11px 25mm 0 0}.executive-box .support-copy{margin-top:8px}.executive-box>.executive-stars{position:absolute;right:9mm;top:13mm;width:22mm;height:31mm}.executive-star{position:absolute;color:var(--terracotta)}.executive-star-one{width:28px;height:28px;right:3mm;top:1mm}.executive-star-two{width:12px;height:12px;right:0;bottom:4mm;color:var(--navy)}.executive-star-three{width:9px;height:9px;left:1mm;bottom:1mm}
