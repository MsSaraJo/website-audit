...
## v4.10 readability / phone-viewing QA
- [ ] Tier 2 page-review prose is comfortably readable without zoom on a typical phone PDF viewer.
- [ ] Tier 2 roadmap and ready-to-use recommendation copy is treated as primary content, not fine print.
- [ ] Tier 3 competitor-profile, gap-analysis, SEO-opportunity, page-opportunity, rewrite, and 90-day-plan copy is comfortably readable.
- [ ] Content labels remain visually secondary but no meaningful label is tiny enough to look accidental.
